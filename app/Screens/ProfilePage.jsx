      ...
      <ScrollView style={{ flex: 1 }}>
        <View style={styles.Profile_content}>
          <View style={styles.image}>
            ...
            <Text style={styles.imgText}>Welcome, Mahmoud</Text>
          </View>

          <View style={styles.info}>
            <View style={styles.info_data}>
              <Text style={styles.dataTitle}>Name: </Text>
              <Text style={styles.dataSub}>Mahmoud</Text>
            </View>
            <View style={styles.info_data}>
              <Text style={styles.dataTitle}>Email: </Text>
              <Text style={styles.dataSub}>Mahmoud@gmail.com</Text>
            </View>
            <View style={styles.info_data}>
              <Text style={styles.dataTitle}>Phone Number: </Text>
              <Text style={styles.dataSub}>01020399283</Text>
            </View>
            <View style={styles.info_data}>
              <Text style={styles.dataTitle}>Country: </Text>
              <Text style={styles.dataSub}>Egypt</Text>
            </View>
